...
class DetalleVentaController extends Controller
{
    ...
    public function consultaDetalleCuentaActual(){
        return DB::select('SELECT d.cantidad,d.subtotal,p.nombre_producto,v.fecha_emision FROM detalle_ventas d, productos p, ventas v WHERE venta_id IN (SELECT id FROM ventas WHERE fecha_pago IS NULL AND tipo_pago = "credito" ) AND d.producto_id = p.id AND d.venta_id = v.id');
    }
