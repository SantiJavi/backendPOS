<?php
namespace App\FirmaElectronica\hacienda;
require(dirname(__FILE__,2) . '/xmlseclibs/xmlseclibs.php');

//use App\FirmaElectronica\xmlseclibs\src\XMLSecurityDSig;
//use App\FirmaElectronica\XMLSecurityKey;
use App\FirmaElectronica\xmlseclibs\XMLSecurityDSig;
use App\FirmaElectronica\xmlseclibs\XMLSecurityKey;
